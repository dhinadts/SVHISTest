...
class RecentActivityListLoadingWidget extends StatelessWidget {
  static const int listItemsMaxCount = 10;
  final int itemCount;

  const RecentActivityListLoadingWidget({this.itemCount = -1});
  ...
  Widget get list => ListView.builder(
      ...
      padding: EdgeInsets.only(left: AppUIDimens.paddingMedium, right: 0),
                        ...
                        Expanded(
                            child: Padding(
                                padding: EdgeInsets.fromLTRB(
                                    ...
                                    AppUIDimens.zeroValue),
                                child: Container(
                                  height: AppUIDimens.shimmerIconHeight + 3,
                                  color: Colors.amber,
                                )))
                      ],
                    ),
