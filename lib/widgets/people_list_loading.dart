...
class PeopleListLoadingWidget extends StatelessWidget {
  static const int listItemsMaxCount = 10;
  final int itemCount;

  const PeopleListLoadingWidget({this.itemCount = -1});
      ...
      Row(
        ...
        children: <Widget>[
          Padding(
              ...
              child: ClipOval(
                  child: Container(
                height: AppUIDimens.peopleListImageSize - 10,
                width: AppUIDimens.peopleListImageSize - 10,
                color: Colors.amber,
              ))),
          Flexible(
              child: SizedBox(
