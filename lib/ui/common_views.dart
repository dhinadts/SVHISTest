...
class CommonViews {
  static var textStyleWithBlack =
      TextStyle(color: Color(ColorInfo.BLACK), fontSize: 18.0);
  static var textStyleWithWhite =
      TextStyle(color: Colors.white, fontSize: 14.0);

  static bool isSearchEnable = false;

  static var textStyleWithBlackNormal =
      TextStyle(color: Color(ColorInfo.BLACK), fontSize: 16.0);
