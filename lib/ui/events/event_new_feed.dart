class EventFeed {
  ...
  EventFeed.fromJson(Map<String, dynamic> json) {
    ...
    if (json['eventFee'] is double) {
      eventFee = json['eventFee'].toString();
    } else {
    ...
    eventRegisterFormDefn = json['eventRegisterFormDefn'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['eventFee'] = this.eventFee;
    data['eventId'] = this.eventId;
    data['eventRegisterFormDefn'] = this.eventRegisterFormDefn;
...
class Sessions {
  ...
  Sessions.fromJson(Map<String, dynamic> json) {
    ...
    startDate = json['startDate'];
    timeZone = json['timeZone'];
    sessionDisplayName = json['sessionDisplayName'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['startDate'] = this.startDate;
    data['timeZone'] = this.timeZone;
    data['sessionDisplayName'] = this.sessionDisplayName;
    return data;
  }
}
