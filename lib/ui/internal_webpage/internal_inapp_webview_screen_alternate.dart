...
class InternalInappWebviewScreenAlternate extends StatefulWidget {
  final String title;
  final String pageURL;

  const InternalInappWebviewScreenAlternate(
      {Key key, @required this.title, @required this.pageURL})
      : super(key: key);

  @override
  _InternalInappWebviewScreenAlternateState createState() =>
      _InternalInappWebviewScreenAlternateState();
}

class _InternalInappWebviewScreenAlternateState
    extends State<InternalInappWebviewScreenAlternate> {
