...
class ShowNewsFeedInAppWebViewScreen extends StatefulWidget {
  final double webViewHeight;

  ShowNewsFeedInAppWebViewScreen({this.webViewHeight});

  @override
  _ShowNewsFeedInAppWebViewScreenState createState() =>
      _ShowNewsFeedInAppWebViewScreenState();
}

class _ShowNewsFeedInAppWebViewScreenState
    extends State<ShowNewsFeedInAppWebViewScreen> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: EdgeInsets.only(top: 0.0, left: 15.0, right: 10.0),
      child: Stack(
        children: [
          InAppWebView(
            ...
            initialUrl:
                ...
                "${AppPreferences().hostUrl}/sites/${AppPreferences().siteNavigator}/newsfeed.html",
