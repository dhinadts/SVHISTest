...
class MembershipCardScreen extends StatefulWidget {
  ...
  const MembershipCardScreen({Key key, @required this.membershipInfo})
      : super(key: key);
...
class _MembershipCardScreenState extends State<MembershipCardScreen> {
  ...
  void initState() {
    super.initState();
    debugPrint("Approved date --> ${widget.membershipInfo.approvedDate}");
    debugPrint("Expiry date --> ${widget.membershipInfo.expiryDate}");
