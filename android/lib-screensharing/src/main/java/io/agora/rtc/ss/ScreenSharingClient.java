...
//    }
    ...
    @TargetApi(21)
    public void start(Context context, String appId, String token, String channelName, int uid, String userFullName, VideoEncoderConfiguration vec) {
        if (mScreenShareSvc == null) {
            ...
            intent.putExtra(Constant.USER_FULL_NAME, userFullName);
